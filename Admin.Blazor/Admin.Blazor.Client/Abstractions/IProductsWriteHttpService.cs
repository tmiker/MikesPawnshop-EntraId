...
namespace Admin.Blazor.Client.Abstractions
{
    ...
    {
        Task<(bool IsSuccess, HealthCheckResultDTO? HealthCheckResultDTO, string? ErrorMessage)> CheckHealthAsync();  // protected endpoint on products write side API, Yarp specific endpoint is anonymous
